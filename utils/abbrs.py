...
def get_abbrs(word_list):
    ...
    EXCLUDE_LIST = ["AB", "BC", "CA", "DZ", "ЕС", "EC", "GPR", "GPS", "GPT", "II", "III", "IP", "MIC", "MSC", "MSK", "PC", "RS", "SG", "SF", "SFP", "SGF", "TOF", "TON", "TP", "UA", "UB", "UC", "UI", "UА", "UБНН", "UС", "VD", "АВ", "ВС", "СА",
                     "ГОСТ", "ЗАКАЗА", "ЗАЩИТ", "ЗАЩИТЫ", "ИЗДЕЛИЯ", "КАРТА", "МИКО", "МОм", "ОБЩЕЕ", "ОЖ", "ПОРЯДОК", "РАЗМЕРЫ", "РЕМОНТ", "СЕРИИ", "СРЕДСТВ", "СТО", "СХЕМ", "СХЕМЫ", "ТФ", "ТЭ", "ФСК", "ФУНКЦИИ",
