...
def get_abbrs(word_list):
    ...
    EXCLUDE_LIST = ["AB", "BC", "CA", "DIN", "DZ", "ЕС", "EC", "EH", "EL", "FB", "FBS", "FTP", "GPR", "GPS", "GPT", "HL", "HNT", "II", "III", "IA", "IB", "IC", "IP", "IT", "JDG", "KD", "KL", "KPX", "KS", "LS", "MIC", "MSC", "MSK", "MT", "NO", "PC", "PE", "PTU", "RPV", "RTK", "RUT",
                     "RS", "SA", "SB", "SG", "SF", "SFP", "SGF", "SMA", "SQ", "TOF", "TON", "TP", "UA", "UB", "UC", "UI", "UZ", "UА", "UБНН", "UС", "UЭ", "VD", "АВ", "ВС", "СА", "XA", "XА", "WE", "XP",
                     "АПВл", "АПВш", "БТ", "ВИДА", "ГОСТ", "ЗАЖИМОВ", "ЗАКАЗА", "ЗАЩИТ", "ЗАЩИТЫ", "ИЗДЕЛИЯ", "КАРТА", "ЛИСТ", "МИКО", "МОм", "ОБЩЕЕ", "ОЖ", "ПОРЯДОК", "РАЗМЕРЫ", "РЕМОНТ", "РЯДОВ", "СЕРИИ", "СРЕДСТВ", "СТО", "CTO", "СХЕМ", "СХЕМА", "СХЕМЫ", "ТОКА", "ТФ", "ТЭ", "ОБЩЕГО", "ФП", "ФСК", "ФУНКЦИИ",
                     "ЦЕПЕЙ", "ЧЕРТЕЖ", "ШКАФ", "ШКАФА", "KR", "KХ", "RJ", "RU", "АААА", "ВC", "ВЭД", "ИК", "ИЛИ", "ИС", "ИФ", "КОД", "НЕ", "НИ", "НК", "НФ", "ОКПД", "ООО", "ПАО", "РАБОТА", "СЕРВИС", "ТП", "ФЗ", "ФФ", "ЮИРЗ", "ЮНИТ", "ЮТКБ"]
