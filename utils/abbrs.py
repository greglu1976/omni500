...
def get_abbrs(word_list):
    ...
    EXCLUDE_LIST = ["AB", "BC", "CA", "CН", "DIN", "DZ", "ЕС", "EC", "EH", "EL", "FB", "FBS", "FTP", "GPR", "GPS", "GPT", "HL", "HNT", "II", "III", "IA", "IB", "IВ", "IC", "IP", "IРЗН", "IT", "IШОН", "JDG", "KA", "KD", "KL", "KPX", "KS", "LS", "MIC", "MSC", "MSK", "MT", "NO", "PC", "PE", "PTU", "RPV", "RTK", "RUT",
                     ...
                     "АК", "АПВл", "АПВш", "АУТС", "БАТ", "БТ", "ВИДА", "ВНИИР", "ГОСТ", "ЖКХ", "ЗАЖИМОВ", "ЗАКАЗА", "ЗАЩИТ", "ЗАЩИТЫ", "ИЗДЕЛИЯ", "КАРТА", "ЛИСТ", "МИКО", "МОм", "НЛПР", "ОБЩ", "ОБЩЕЕ", "ОЖ", "ОЖО", "ОРТИС", "ПОРЯДОК", "ППЗ", "ПРM", "РАЗМЕРЫ", "РЕМОНТ", "РЯДОВ", "СЕРИИ", "СКЛ", "СРЕДСТВ", "СТО", "CTO", "СТЭЗ", "СХЕМ", "СХЕМА", "СХЕМЫ", "ТОКА", "ТФ", "ТЭ", "ОБЩЕГО", "ФП", "ФСК", "ФУНКЦИИ",
