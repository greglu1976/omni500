...
def get_abbrs(word_list):
    ...
    EXCLUDE_LIST = ["AB", "BC", "CA", "DZ", "ЕС", "EC", "GPR", "GPS", "GPT", "II", "III", "IP", "MIC", "MSC", "MSK", "PC", "RS", "SA", "SG", "SF", "SFP", "SGF", "TOF", "TON", "TP", "UA", "UB", "UC", "UI", "UА", "UБНН", "UС", "UЭ", "VD", "АВ", "ВС", "СА", "XA", "XА",
                     "АПВл", "АПВш", "БТ", "ГОСТ", "ЗАКАЗА", "ЗАЩИТ", "ЗАЩИТЫ", "ИЗДЕЛИЯ", "КАРТА", "ЛИСТ", "МИКО", "МОм", "ОБЩЕЕ", "ОЖ", "ПОРЯДОК", "РАЗМЕРЫ", "РЕМОНТ", "СЕРИИ", "СРЕДСТВ", "СТО", "CTO", "СХЕМ", "СХЕМА", "СХЕМЫ", "ТОКА", "ТФ", "ТЭ", "ФП", "ФСК", "ФУНКЦИИ",
                     "ЦЕПЕЙ", "ШКАФ", "ШКАФА", "KR", "KХ", "RJ", "RU", "АААА", "ВC", "ВЭД", "ИК", "ИЛИ", "ИС", "ИФ", "КОД", "НЕ", "НИ", "НК", "НФ", "ОКПД", "ООО", "ПАО", "РАБОТА", "СЕРВИС", "ТП", "ФЗ", "ФФ", "ЮИРЗ", "ЮНИТ", "ЮТКБ"]
